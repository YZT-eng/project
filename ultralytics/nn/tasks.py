...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n.yaml", ch=3, nc=None, verbose=True):
        ...
        # Build strides
        m = self.model[-1]  # Detect()
        if isinstance(m, (Detect,v11Detect_ASFFHead)):  # includes all Detect subclasses like Segment, Pose, OBB, YOLOEDetect, YOLOESegment
            s = 640  # 2x min stride
...
def parse_model(d, ch, verbose=True):
    ...
    base_modules = frozenset(
        {Classify,Conv,ConvTranspose,GhostConv,Bottleneck,GhostBottleneck,SPP,SPPF,C2fPSA,C2PSA,DWConv,Focus,BottleneckCSP,C1,C2,C2f,C3k2,RepNCSPELAN4,ELAN1,ADown,
         AConv,SPPELAN,C2fAttn,C3,C3TR,C3Ghost,torch.nn.ConvTranspose2d,DWConvTranspose2d,C3x,RepC3,PSA,SCDown,C2fCIB,A2C2f,
         C3k2_DEConv,C3k2_DEConv2,HWD,C3k2_GhostModule_DynamicConv,DynamicConv,EMCAM,SPDConv,FCM,FCM_1,FCM_2,FCM_3,Down,Pzconv,C3k2_MKP,LDConv,C3k2_LDConv,
         AKConv, AKC3k2,C3k2_FCA,PConv,SPConv,C3k2_PConv,C3k2_SPConv,C3k2_RFAConv, RFAConv,C3k2_SCConv,LSKASPPF,C3k2_LSKA,C3k2_EMA,CSPStage,C3k2_GatedAttention,
        }
    )
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            BottleneckCSP,C1,C2,C2f,C3k2,C2fAttn,C3,C3TR,C3Ghost,C3x,RepC3,C2fPSA,C2fCIB,C2PSA,A2C2f,C3k2_DEConv,C3k2_DEConv2,C3k2_GhostModule_DynamicConv,
            C3k2_MKP,C3k2_LDConv,AKC3k2,C3k2_FCA,C3k2_PConv,C3k2_SPConv,C3k2_RFAConv,C3k2_SCConv,C3k2_LSKA,C3k2_EMA,CSPStage,C3k2_GatedAttention
        }
    )
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            args = [length]
        elif m in (DEConv,BiLevelRoutingAttention,MultiDilatelocalAttention,CARAFE,FCAttention,DySample,SCConv,LSKA,EMA,GatedAttention):
            c2 = ch[f]
            args = [c2, *args]

        elif m in { CGAFusion,PSFM,CAFMFusion,DAAttn}:
            c2 = ch[f[1]]
            args = [c2, *args]
            ...
            c2 = m.channel
            backbone = True
        elif m in {MobileNetV1, MobileNetV2,MobileNetV3,MobileNetV4ConvLarge, MobileNetV4ConvSmall, MobileNetV4ConvMedium, MobileNetV4HybridMedium, MobileNetV4HybridLarge}:
            m = m()
            c2 = m.width_list
            backbone = True
        ...
        # ------------------------------ASF-YOLO--------------------------------
            ...
            {Detect, WorldDetect, YOLOEDetect, Segment, YOLOESegment, Pose, OBB, ImagePoolingAttn, v10Detect,v11Detect_ASFFHead}
        ):
    ...
    if isinstance(model, torch.nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, (Segment, YOLOESegment)):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, YOLOEDetect, v10Detect,v11Detect_ASFFHead)):
                return "detect"
