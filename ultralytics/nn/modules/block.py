...
class SimAM(nn.Module):
    ...
    This module implements a simple attention mechanism that doesn't require additional parameters.
    """
    ...
    def __init__(self, c1=None, c2=None, e_lambda=1e-4):
        ...
        Args:
            channels (int | None): Number of channels (not used, kept for compatibility).
            e_lambda (float): Lambda parameter for numerical stability. Default is 1e-4.
        """
